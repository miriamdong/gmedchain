...
const testmonials = [
  {
    ...
    desig: 'Head of  Mahrs',
    text:
      'Edefy template dolor sit amet, consectetur adipiscing elit, beautiful sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ',
    id: 1,
  },
  {
    image: test2,
  ...
  return (
    <Grid className="testmonialArea ptb-104">
      <Grid container spacing={4} className="container">
        ...
        <Grid xs={12} item>
          <Slider className="testSliders" {...settings}>
